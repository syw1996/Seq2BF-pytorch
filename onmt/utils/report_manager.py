...
class ReportMgr(ReportMgrBase):
    ...
    def _report_step(self, lr, step, train_stats=None, valid_stats=None):
        ...
        if valid_stats is not None:
            with open("/home/sunyawei/project/OpenNMT-keyword/data/log.txt", "a") as f:
                f.write('Validation perplexity: ' + str(valid_stats.ppl()) + "\t" + 'Validation accuracy: ' + str(valid_stats.accuracy()) + "\n")
