...
class LossComputeBase(nn.Module):
    ...
    def _compute_loss(self, train_forward, batch, output, target, **kwargs):
        """
    ...
    def monolithic_compute_loss(self, batch, output, attns, train_forward):
        """
        ...
        _, batch_stats = self._compute_loss(train_forward, batch, **shard_state)

        return batch_stats

    def sharded_compute_loss(self, batch, output, attns,
                             cur_trunc, trunc_size, shard_size,
                             normalization, train_forward):
        ...
        for shard in shards(shard_state, shard_size):
            loss, stats = self._compute_loss(train_forward, batch, **shard)
...
class NMTLossCompute(LossComputeBase):
    ...
    # 计算整个sequence的loss
    # target: [sequence_size, batch_size]
    # output: [sequence_size, batch_size, hidden_size]
    # scores: [sequence_size x batch_size, vocab_size]
    def _compute_loss(self, train_forward, batch, output, target):
