...
def train_opts(parser):
    ...
    group.add_argument('-save_model', default='model',
                       ...
                       of steps""")
    group.add_argument('-train_forward', default=True, type=bool,
                       help='decide whether train forward or backward')

    group.add_argument('-save_checkpoint_steps', type=int, default=10000,
    ...
    group.add_argument('-max_generator_batches', type=int, default=32,
                       help="""Maximum batches of words in a sequence to run
                        ...
                        uses more memory.""")
    group.add_argument('-train_steps', type=int, default=600000,
    ...
    group.add_argument('-learning_rate_decay', type=float, default=0.97,
...
def translate_opts(parser):
    ...
    group.add_argument('-backward_model', type=str, required=True)
    ...
    group.add_argument('-alpha', type=float, default=1,
