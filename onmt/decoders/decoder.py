...
class RNNDecoderBase(nn.Module):
    ...
    def forward(self, tgt, memory_bank, state, train_forward, memory_lengths=None,
                step=None):
        """
        Args:
        ...
        decoder_final, decoder_outputs, attns = self._run_forward_pass(
            tgt, memory_bank, state, train_forward, memory_lengths=memory_lengths)
...
class InputFeedRNNDecoder(RNNDecoderBase):
    ...
    def _run_forward_pass(self, tgt, memory_bank, state, train_forward=False, memory_lengths=None):
        """
